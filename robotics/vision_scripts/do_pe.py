...
def do_pose_estimation(scene_pointcloud, object_pointcloud):
    ...
    # Skip visualization - only show FPFH, RANSAC, ICP
    show_point_clouds([dbscan_pcd], "3a. DBSCAN CLUSTERING", info, debug=False)
    ...
    # Skip visualization - only show FPFH correspondences and ICP
